...
ArrayType* arithmetic_set_helper( ArrayType *input1, ArrayType *input2, Int4RangeSet (*callback)() );
...
*/
ArrayType*
arithmetic_set_helper(ArrayType *input1, ArrayType *input2, Int4RangeSet (*callback)() )
{   
    Datum *elems1, *elems2;
    bool *nulls1, *nulls2;
    int n1, n2;
